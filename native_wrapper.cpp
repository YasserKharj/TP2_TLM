...
{
    //The excecution will be blocked for 1 milli-second
...
{
    //if there is no interrept, wait till the interrupt event
    if (!interrupt){
...
interrupt = true;
//notify that the interrupt has occured
